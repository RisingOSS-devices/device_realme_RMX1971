...
# Device Tree
rm -rf device/realme/RMX1971 && git clone https://github.com/risingOSS-Devices/device_realme_RMX1971 -b 13 device/realme/RMX1971
...
# Vendor Common Tree
rm -rf vendor/realme/sdm710-common && git clone https://gitlab.com/kssrao13882/vendor_realme_sdm710-common.git -b 13.1 vendor/realme/sdm710-common
